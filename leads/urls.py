...
urlpatterns = [
    ...
    path('leads/bulk-upload/preview/', BulkUploadPreviewView.as_view(), name='lead-bulk-upload-preview'),
    ...
    path('staff-analysis/followups/', StaffAnalysisFollowUpsAPIView.as_view(), name='staff-analysis-followups'),
]