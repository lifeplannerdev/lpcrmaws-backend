...
# We will not set DEFAULT_FILE_STORAGE here globally to prevent breaking existing Cloudinary usage.
# Instead, we will specify the storage explicitly in the ProcessingStudentDocument model.
