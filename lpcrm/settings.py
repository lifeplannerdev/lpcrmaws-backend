...
# Google Sheets API & FDS Live Sync
GOOGLE_SHEETS_CREDENTIALS_FILE = config('GOOGLE_SHEETS_CREDENTIALS_FILE', default=os.path.join(BASE_DIR, 'google_sheets_credentials.json'))
FDS_SHEET1_ID_OR_TITLE = config('FDS_SHEET1_ID_OR_TITLE', default='FDS KTM-2026-JOINING DETAILS & ACCOUNTS -FEES STRUCTURE _ FEES COLLECTIONS -REGULAR BATCH')
FDS_SHEET2_ID_OR_TITLE = config('FDS_SHEET2_ID_OR_TITLE', default='FDS KTM-ENQUIRY_ TRIAL-2026')
